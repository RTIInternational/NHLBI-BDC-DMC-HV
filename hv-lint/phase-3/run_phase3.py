...
Usage:
    python QC/hv-lint/phase-3/run_phase3.py --cache-dir QC/hv-lint/dbgap-cache
    python QC/hv-lint/phase-3/run_phase3.py --cache-dir QC/hv-lint/dbgap-cache --cohort ARIC
"""
