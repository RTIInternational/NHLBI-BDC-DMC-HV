...
Usage:
    python QC/hv-lint/phase-3/validate_dbgap_crossref.py --cache-dir QC/hv-lint/dbgap-cache
    python QC/hv-lint/phase-3/validate_dbgap_crossref.py --cache-dir QC/hv-lint/dbgap-cache --cohort ARIC
