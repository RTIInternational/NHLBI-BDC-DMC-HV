...
Usage:
    python QC/hv-lint/phase-1/check_quoting_rules.py                   # all cohorts
    python QC/hv-lint/phase-1/check_quoting_rules.py --cohort FHS      # single cohort
    python QC/hv-lint/phase-1/check_quoting_rules.py --summary         # counts only
"""
