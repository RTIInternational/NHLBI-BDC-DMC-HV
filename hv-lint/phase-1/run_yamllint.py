...
Wrapper script that points yamllint at the correct config (QC/.yamllint)
and targets the appropriate cohort directories in the HV repo.

Usage:
    python QC/hv-lint/phase-1/run_yamllint.py                     # all cohorts
    python QC/hv-lint/phase-1/run_yamllint.py --cohort FHS        # single cohort
    python QC/hv-lint/phase-1/run_yamllint.py --cohort FHS --format parsable
    python QC/hv-lint/phase-1/run_yamllint.py --summary           # counts only
"""
