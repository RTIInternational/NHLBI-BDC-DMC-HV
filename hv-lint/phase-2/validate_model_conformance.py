...
Usage:
    python QC/hv-lint/phase-2/validate_model_conformance.py
    python QC/hv-lint/phase-2/validate_model_conformance.py --bdchm-ref v1.2.0 --cohort ARIC
    python QC/hv-lint/phase-2/validate_model_conformance.py --bdchm-schema path/to/bdchm.yaml
...
# ---------------------------------------------------------------------------
# Check 2.1: LinkML-Map key validation
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Checks 2.2, 2.3, 2.4, 2.5, 2.6 — recursive class_derivations walk
# ---------------------------------------------------------------------------
