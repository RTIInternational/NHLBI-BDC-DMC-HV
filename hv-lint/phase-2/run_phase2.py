...
Usage:
    python QC/hv-lint/phase-2/run_phase2.py                            # all cohorts
    python QC/hv-lint/phase-2/run_phase2.py --cohort FHS               # single cohort
    python QC/hv-lint/phase-2/run_phase2.py --skip dedup               # skip PHV dedup
    python QC/hv-lint/phase-2/run_phase2.py --bdchm-ref v1.2.0        # pin schema version
"""
