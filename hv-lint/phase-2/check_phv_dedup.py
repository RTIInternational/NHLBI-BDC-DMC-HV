...
Usage:
    python QC/hv-lint/phase-2/check_phv_dedup.py
    python QC/hv-lint/phase-2/check_phv_dedup.py --cohort ARIC
    python QC/hv-lint/phase-2/check_phv_dedup.py --fail-on warning
"""
