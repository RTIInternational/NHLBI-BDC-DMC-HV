...
/*		3. Clean data																*/
/*		4. Curate data																*/
/*		5. Merge data and documentation												*/
/*		6. Perform QC																*/
/*		7. Generate YAML code														*/
/*																					*/
...
/* ----- 4. Curate data ----- */
do "$prog/DMCYAML_04_CurateData.do"

/* ----- 5. Merge data and documentation ----- */
do "$prog/DMCYAML_05_MergeDataDocs.do"

/* ----- 6. Peform QC ----- */
* Note: manual data processes are performed by human curators at this stage, enabled by the code *;
do "$prog/DMCYAML_06_QC.do"

/* ----- 7. Generate YAML code ----- */
do "$prog/DMCYAML_07_GenerateYAML.do"
