...
python find_participant_gap.py

# Custom source root
python find_participant_gap.py --source-root /sbgenomics/project-files/.../COPDGene
```
...
```bash
# Source extract
python NHLBI-BDC-DMC-HV/hv-dataqc/extract-source/extract_source_summaries.py \
    --cohort COPDGene \
...
python NHLBI-BDC-DMC-HV/hv-dataqc/extract-harmonized/extract_harmonized_summaries.py \
    --cohort COPDGene \
    --mapped-data-dirs \
